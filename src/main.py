...
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('DATABASE_URL', 'postgresql+psycopg://neondb_owner:npg_4c7zqFAwjNRg@ep-delicate-glitter-adqzwgrq-pooler.c-2.us-east-1.aws.neon.tech/neondb?sslmode=require')
